...
const latin_js_1 = __importDefault(require("./latin.js"));
const cyrilic_js_1 = __importDefault(require("./cyrilic.js"));
function cyrilicToLatin(text) {
    return transliterate(text, cyrilic_js_1.default.STREAMLINED);
}
exports.cyrilicToLatin = cyrilicToLatin;
function latinToCyrilic(text) {
    return transliterate(text, latin_js_1.default.STREAMLINED);
}
